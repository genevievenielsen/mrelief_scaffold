...
class TwilioSpanishController < ApplicationController
  ...
  if params[:Body].strip.downcase == "hello" || params[:Body].strip.downcase == "hi" || params[:Body].strip.downcase == "hola"
   ...
   if session["counter"] == 0
    message = "Welcome to mRelief! We help you check your eligibility for benefits. For foodstamps, text the word 'food'.  If you make a mistake, send the message 'reset'."
   end
