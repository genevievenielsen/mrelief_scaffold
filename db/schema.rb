...
ActiveRecord::Schema.define(version: 20160122232008) do
  ...
  create_table "early_learning_data", force: true do |t|
    ...
    t.boolean  "data_sharing",                                  default: false
  end
  ...
  create_table "wic_data", force: true do |t|
    ...
    t.string   "pregnant_or_child"
    t.string   "snap_tanf_medicaid"
  end

  create_table "wic_locations", force: true do |t|
    t.string   "address"
    t.string   "city"
    t.string   "state"
    t.string   "zipcode"
